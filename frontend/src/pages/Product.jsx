...
//   return productData ? (
//     <div className=' border-t-2 pt-10 px-8 lg:px-24'>
//       {/* Product data */}
...
//               alt={`Product ${index}`}
//               onClick={() => setImage(item)} // ✅ Clicking a thumbnail updates main image
//             />
//           ))}
//           </div>
...
//           <h1 className="font-mediumd text-2xl mt-2">{productData.name}</h1>
...
//             <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore ex dolore dolorem iure magni dolores fugiat voluptatibus quidem laborum, porro dignissimos, enim dicta maiores aut mollitia molestiae nihil, cum rerum.</p>
//             <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Commodi impedit eum hic illum. In maiores dicta doloribus quam cum eligendi dolorem quos illum eaque alias fuga dolorum, beatae eius et.</p>
//       </div>
